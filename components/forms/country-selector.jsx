...
const countries = [
  ...
  { name: 'United Nations', code: 'UN', emoji: '🇺🇳' },
          ...
          <Command className="rounded-xl">
            ...
            <CommandList className="p-1">
              ...
              {countries.map(country => (
                ...
                >
                  <span className="text-lg leading-none">{country.emoji}</span> {country.name}
                  {value === country.code && <CheckIcon size={16} className="ml-auto" />}
                </CommandItem>
              ))}
            </CommandList>
          </Command>
...
// Export countries for other components that might need the data
export { countries };
