...
const navigation = {
  ...
  social: [
      ...
      icon: props => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <g clipPath="url(#clip0_2232_245)">
            <path d="M0 1.719C0 .769.789 0 1.763 0h20.475C23.21 0 24 .77 24 1.719v20.562c0 .95-.789 1.719-1.762 1.719H1.762C.788 24 0 23.23 0 22.281zm7.415 18.372V9.254H3.813V20.09zm-1.8-12.318c1.255 0 2.037-.831 2.037-1.872-.023-1.063-.78-1.872-2.014-1.872-1.232 0-2.038.81-2.038 1.872 0 1.041.781 1.872 1.99 1.872zm7.361 12.318v-6.052c0-.325.024-.649.12-.88.26-.646.852-1.317 1.848-1.317 1.304 0 1.824.993 1.824 2.451v5.798h3.602v-6.216c0-3.33-1.776-4.878-4.146-4.878-1.911 0-2.767 1.05-3.248 1.79v.037h-.024l.024-.037V9.254h-3.6c.046 1.017 0 10.837 0 10.837z"></path>
          </g>
          <defs>
            <clipPath id="clip0_2232_245">
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/koellabs',
      icon: props => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/koellabs/',
      icon: props => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@koellabs',
      icon: props => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Footer() {
  return (
    <footer
      data-cursor-opacity="0.1"
      data-cursor-size="20"
      className="bg-white/50 backdrop-blur-md border-neutral-200 z-[999] relative"
    >
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0 grid-flow-col">
            <div className="md:grid md:grid-cols-2 md:gap-8 ">
              <div></div>
              <div className="">
                <h3 className="text-sm/6 font-semibold text-neutral-900">Research</h3>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-neutral-900">Lab</h3>
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.lab.map(item => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="text-sm/6 text-neutral-600 hover:text-neutral-900"
