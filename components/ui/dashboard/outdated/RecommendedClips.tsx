...
interface RecommendedClipsProps {
  clips: Clip[];
}

export default function RecommendedClips({ clips }: RecommendedClipsProps) {
  ...
  const renderClip = (clip: Clip) => (
    ...
    >
      <Card className="border text-neutral-500 dark:text-neutral-400 border-accent dark:border-accent-dark rounded-lg bg-neutral-200/50 dark:bg-neutral-800/50 border-neutral-300 dark:border-neutral-700">
      ...
      <div className="flex justify-between items-center p-4">
        ...
        {showViewAllButton && (
          <Button
            ...
            variant="outline"
            size="sm"
            className="rounded-xl tracking-tight dark:border-neutral-700 dark:text-neutral-300"
          >
