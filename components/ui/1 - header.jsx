        ...
        <ContextMenu>
          <ContextMenuTrigger>
            <a href="/" className="text-2xl font-semibold  tracking-[-0.04em] flex justify-center">
              ...
              Koel <span className='ml-1 text-transparent bg-clip-text bg-gradient-to-br from-black via-sky-950 to-sky-500'>Labs</span>
            </a>
          </ContextMenuTrigger>
          <ContextMenuContent className="w-full p-1 flex flex-col">
            <button onClick={handleClickLogo}>
              <ContextMenuItem className="text-neutral-900 tracking-tight text-sm font-medium"><Copy className="mr-3 h-5 w-5" />Copy Logo as SVG</ContextMenuItem>
            </button>
            <button onClick={handleClickBrandmark}>
              <ContextMenuItem className="text-neutral-900 tracking-tight text-sm font-medium"> <svg className="mr-2 h-6 w-6" width="493" height="601" viewBox="0 0 493 601" fill="none" xmlns="http://www.w3.org/2000/svg"> <rect x="479.179" y="247" width="188" height="403" rx="94.0001" transform="rotate(90 479.179 247)" stroke="black" stroke-width="40"/> <rect x="455.285" y="493.406" width="188" height="403" rx="94.0001" transform="rotate(135 455.285 493.406)" stroke="black" stroke-width="40"/> <path d="M108.854 192.813C98.1134 188.828 86.3026 179.102 74.3071 164.925C62.5107 150.984 51.4888 133.887 42.0472 116.898C32.6292 99.9516 24.9668 83.4451 19.8286 70.8909C17.6616 65.5965 15.9875 61.1119 14.8314 57.6678C17.9542 55.8112 22.1483 53.5038 27.2441 50.904C39.3274 44.7394 55.902 37.2253 74.094 30.523C92.3318 23.8038 111.838 18.0333 129.873 15.1601C148.212 12.2384 163.509 12.5691 174.25 16.5541C222.923 34.6126 247.74 88.709 229.682 137.382C211.623 186.054 157.527 210.872 108.854 192.813Z" stroke="black" stroke-width="40"/> </svg>Copy Brandmark as SVG</ContextMenuItem>
            </button>
          </ContextMenuContent>
        </ContextMenu>
