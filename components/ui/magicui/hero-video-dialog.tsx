      ...
      <Link href={videoSrc} target="_blank">
        <div className="relative cursor-pointer group">
          <img
            ...
            width={1920}
            height={1080}
            className="w-full transition-all duration-200 group-hover:brightness-[0.9] ease-out rounded-xl shadow-lg border"
          />
          <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-2xl">
            <div className="bg-sky-900/20 flex items-center justify-center rounded-full backdrop-blur-md size-28">
              ...
              >
                ...
                /> */}
                <ArrowUpRight
                  className="size-8 text-white  group-hover:scale-105 scale-100 transition-transform duration-200 ease-out"
                  style={{
                    filter:
                      'drop-shadow(0 4px 3px rgb(3 105 161 / 0.07)) drop-shadow(0 2px 2px rgb(3 105 161 / 0.06))',
                  }}
