...
See [DEVELOPMENT.md](DEVELOPMENT.md) for how to setup your local development environment. If you just want to self-host the application, follow the instructions below.
