        ...
        <div className="mx-auto grid w-full p-4 sm:w-[405px] gap-6">
          <div className="grid gap-2 text-center">
            <h1 className="text-3xl font-bold tracking-tight ">
              <span className="relative mr-1 ml-6 text-transparent bg-clip-text bg-gradient-to-br from-black via-black to-sky-600 dark:from-neutral-100 dark:via-neutral-100 dark:to-neutral-100">               <svg className='h-10 w-10 absolute -left-10 -mt-1 hidden dark:inline'   width="870" height="870" viewBox="0 0 870 870" fill="none" xmlns="http://www.w3.org/2000/svg"> <rect x="671.179" y="403" width="214" height="429" rx="107" transform="rotate(90 671.179 403)" fill="url(#paint0_linear_1720_505)" fillOpacity="0.6"/> <rect x="652.67" y="662.406" width="214" height="429" rx="107" transform="rotate(135 652.67 662.406)" fill="url(#paint1_linear_1720_505)" fillOpacity="0.6"/> <rect x="671.179" y="403" width="214" height="429" rx="107" transform="rotate(90 671.179 403)" fill="url(#paint2_linear_1720_505)" fillOpacity="0.6"/> <rect x="652.67" y="662.406" width="214" height="429" rx="107" transform="rotate(135 652.67 662.406)" fill="url(#paint3_linear_1720_505)" fillOpacity="0.6"/> <rect x="671.179" y="403" width="214" height="429" rx="107" transform="rotate(90 671.179 403)" fill="url(#paint4_linear_1720_505)" fillOpacity="0.6"/> <rect x="652.67" y="662.406" width="214" height="429" rx="107" transform="rotate(135 652.67 662.406)" fill="url(#paint5_linear_1720_505)" fillOpacity="0.6"/> <path d="M283.332 374.002C227.928 353.446 177.024 227.365 179.285 221.271C181.546 215.177 302.368 152.81 357.772 173.366C413.176 193.922 441.426 255.5 420.87 310.904C400.314 366.308 338.736 394.558 283.332 374.002Z" fill="white"/> <defs> <linearGradient id="paint0_linear_1720_505" x1="778.179" y1="403" x2="778.179" y2="832" gradientUnits="userSpaceOnUse"> <stop stopColor="#317EC5"/> <stop offset="1" stopColor="white"/> </linearGradient> <linearGradient id="paint1_linear_1720_505" x1="759.67" y1="662.406" x2="759.67" y2="1091.41" gradientUnits="userSpaceOnUse"> <stop stopColor="#317EC5"/> <stop offset="1" stopColor="white"/> </linearGradient> <linearGradient id="paint2_linear_1720_505" x1="778.179" y1="403" x2="778.179" y2="832" gradientUnits="userSpaceOnUse"> <stop stopColor="#317EC5"/> <stop offset="1" stopColor="white"/> </linearGradient> <linearGradient id="paint3_linear_1720_505" x1="759.67" y1="662.406" x2="759.67" y2="1091.41" gradientUnits="userSpaceOnUse"> <stop stopColor="#317EC5"/> <stop offset="1" stopColor="white"/> </linearGradient> <linearGradient id="paint4_linear_1720_505" x1="778.179" y1="403" x2="778.179" y2="832" gradientUnits="userSpaceOnUse"> <stop stopColor="#317EC5"/> <stop offset="1" stopColor="white"/> </linearGradient> <linearGradient id="paint5_linear_1720_505" x1="759.67" y1="662.406" x2="759.67" y2="1091.41" gradientUnits="userSpaceOnUse"> <stop stopColor="#317EC5"/> <stop offset="1" stopColor="white"/> </linearGradient> </defs> </svg> <svg           className='h-10 w-10 absolute -left-10 -mt-1 dark:hidden'           xmlns="http://www.w3.org/2000/svg"           width="870"           height="870"           fill="none"           viewBox="0 0 870 870"         >           <rect             width="214"             height="429"             x="671.179"             y="403"             fill="url(#paint0_linear_1691_806)"             fillOpacity="0.6"             rx="107"             transform="rotate(90 671.179 403)"           ></rect>           <rect             width="214"             height="429"             x="652.67"             y="662.406"             fill="url(#paint1_linear_1691_806)"             fillOpacity="0.6"             rx="107"             transform="rotate(135 652.67 662.406)"           ></rect>           <rect             width="214"             height="429"             x="671.179"             y="403"             fill="url(#paint2_linear_1691_806)"             fillOpacity="0.6"             rx="107"             transform="rotate(90 671.179 403)"           ></rect>           <rect             width="214"             height="429"             x="652.67"             y="662.406"             fill="url(#paint3_linear_1691_806)"             fillOpacity="0.6"             rx="107"             transform="rotate(135 652.67 662.406)"           ></rect>           <rect             width="214"             height="429"             x="671.179"             y="403"             fill="url(#paint4_linear_1691_806)"             fillOpacity="0.6"             rx="107"             transform="rotate(90 671.179 403)"           ></rect>           <rect             width="214"             height="429"             x="652.67"             y="662.406"             fill="url(#paint5_linear_1691_806)"             fillOpacity="0.6"             rx="107"             transform="rotate(135 652.67 662.406)"           ></rect>           <path             fill="#000"             d="M283.332 374.002c-55.404-20.556-106.308-146.637-104.047-152.731 2.261-6.094 123.083-68.461 178.487-47.905 55.404 20.556 83.654 82.134 63.098 137.538-20.556 55.404-82.134 83.654-137.538 63.098z"           ></path>           <defs>             <linearGradient               id="paint0_linear_1691_806"               x1="778.179"               x2="778.179"               y1="403"               y2="832"               gradientUnits="userSpaceOnUse"             >               <stop stopColor="#317EC5"></stop>               <stop offset="1"></stop>             </linearGradient>             <linearGradient               id="paint1_linear_1691_806"               x1="759.67"               x2="759.67"               y1="662.406"               y2="1091.41"               gradientUnits="userSpaceOnUse"             >               <stop stopColor="#317EC5"></stop>               <stop offset="1"></stop>             </linearGradient>             <linearGradient               id="paint2_linear_1691_806"               x1="778.179"               x2="778.179"               y1="403"               y2="832"               gradientUnits="userSpaceOnUse"             >               <stop stopColor="#317EC5"></stop>               <stop offset="1"></stop>             </linearGradient>             <linearGradient               id="paint3_linear_1691_806"               x1="759.67"               x2="759.67"               y1="662.406"               y2="1091.41"               gradientUnits="userSpaceOnUse"             >               <stop stopColor="#317EC5"></stop>               <stop offset="1"></stop>             </linearGradient>             <linearGradient               id="paint4_linear_1691_806"               x1="778.179"               x2="778.179"               y1="403"               y2="832"               gradientUnits="userSpaceOnUse"             >               <stop stopColor="#317EC5"></stop>               <stop offset="1"></stop>             </linearGradient>             <linearGradient               id="paint5_linear_1691_806"               x1="759.67"               x2="759.67"               y1="662.406"               y2="1091.41"               gradientUnits="userSpaceOnUse"             >               <stop stopColor="#317EC5"></stop>               <stop offset="1"></stop>             </linearGradient>           </defs>         </svg>             
                Koel Login
              </span></h1>
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="password" className="dark:text-white" type="password" required value={password} onChange={(e) => setPassword(e.target.value)} />
            </div>
            <Button className="w-full dark:text-white bg-gradient-to-br py-0 border border-double outline-white/50 outline outline-[0.1px] outline-offset-[-2px] border-black from-sky-800 to-blue-950 dark:outline-black/50 dark:from-sky-600 dark:to-blue-800" type="submit">
              Login
            </Button>
            <div className="flex flex-row gap-2 items-center">
              <div className="h-0.5 bg-neutral-200 dark:bg-neutral-800 w-full"></div>
              <p className="xss:w-[338px] text-sm text-neutral-500 dark:text-neutral-300"><span className="">Or</span><span className="hidden xss:inline"> continue with</span></p>
              <div className="h-0.5 bg-neutral-200 dark:bg-neutral-800 w-full"></div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <Button className="w-full bg-white text-neutral-800 hover:bg-neutral-100 border border-neutral-200 dark:bg-neutral-900 dark:border-neutral-800 dark:text-white">
                <svg className="h-5 w-5 mr-1.5" width="754" height="768" viewBox="0 0 754 768" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Button className="w-full bg-white text-neutral-800 hover:bg-neutral-100 border border-neutral-200 dark:bg-neutral-900 dark:border-neutral-800 dark:text-white">
                <svg className="h-8 w-8 mr-0.5" width="934" height="934" viewBox="0 0 934 934" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Button className="w-full bg-white text-neutral-800 hover:bg-neutral-100 border border-neutral-200 dark:bg-neutral-900 dark:border-neutral-800 dark:text-white">
              <svg className="h-5 w-5 mr-2" width="171" height="172" viewBox="0 0 171 172" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M81.1557 81.7631H0V0.607422H81.1557V81.7631Z" fill="#F1511B"/> <path d="M170.761 81.7631H89.6064V0.607422H170.761V81.7631Z" fill="#80CC28"/> <path d="M81.1534 171.399H0V90.2441H81.1534V171.399Z" fill="#00ADEF"/> <path d="M170.761 171.399H89.6064V90.2441H170.761V171.399Z" fill="#FBBC09"/> </svg>
                Microsoft
              </Button>
