        ...
        <div className="mx-auto grid w-full p-4 sm:w-[405px] gap-6">
          ...
          <div className="grid gap-4">
            ...
            <div className="grid sm:grid-cols-2 gap-2">
              ...
              <Button className="w-full bg-white text-neutral-800 hover:bg-neutral-100 border border-neutral-200 dark:bg-neutral-900 dark:border-neutral-800 dark:text-white h-10 rounded-lg">
                <svg
